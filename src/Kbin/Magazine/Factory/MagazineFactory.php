...
namespace App\Kbin\Magazine\Factory;
...
use App\Factory\ModeratorFactory;
...
readonly class MagazineFactory
{
    ...
    public function createResponseDto(MagazineDto|Magazine $magazine): MagazineResponseDto
    {
        ...
        return MagazineResponseDto::create(
            ...
            $dto->isBlockedByUser,
            $dto->tags,
            array_map(fn (Badge|EntryBadgeDto $badge) => new EntryBadgeResponseDto($badge), $dto->badges?->toArray() ?? []),
